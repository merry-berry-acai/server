...
// Update to use public/images directory to match seeding.js
const imagesPath = path.join(process.cwd(), "public", "images");

// Ensure the images directory exists
if (!fs.existsSync(imagesPath)) {
  Logger.warn(
    `Images directory not found at ${imagesPath}. Creating directory...`
  );
...
router.post(
  ...
  asyncHandler(async (req, res) => {
    try {
      ...
      // Update path to match the expected format in database
      sendSuccess(
        res,
        {
...
router.put(
  ...
  asyncHandler(async (req, res) => {
    try {
      ...
      // Make sure path matches format in database
      sendSuccess(
        res,
        {
          filename: filename,
...
// Note: This route is now mounted at /api/images in server.js, but the static
// files in public/images are directly accessible via /images/filename.jpeg
// This allows the imageUrl paths stored in the database to work correctly
